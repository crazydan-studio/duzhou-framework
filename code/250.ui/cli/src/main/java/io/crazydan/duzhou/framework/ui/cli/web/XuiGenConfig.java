...
package io.crazydan.duzhou.framework.ui.cli.web;
...
public abstract class XuiGenConfig {
    ...
    public static final IConfigReference<String> CFG_FONT_SIZE = //
            varRef(s_loc, "duzhou.ui.vendor.web.font-size", String.class, "16px");
    @Description("1u 对应的实际尺寸")
    public static final IConfigReference<String> CFG_BASE_SIZE = //
            varRef(s_loc, "duzhou.ui.vendor.web.base-size", String.class, "1rem");
    @Description("1i 对应的实际尺寸")
    public static final IConfigReference<String> CFG_LINE_SIZE = //
            varRef(s_loc, "duzhou.ui.vendor.web.line-size", String.class, "1px");
