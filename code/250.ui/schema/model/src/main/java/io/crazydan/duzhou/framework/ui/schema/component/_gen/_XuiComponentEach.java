...
public abstract class _XuiComponentEach extends io.crazydan.duzhou.framework.ui.schema.component.XuiComponentNested {
     ...
     * > (必填) 如 `props.users`
     */
    private io.crazydan.duzhou.framework.ui.XuiExpression<java.util.List> _list ;
    ...
    public io.crazydan.duzhou.framework.ui.XuiExpression<java.util.List> getList(){
      return _list;
    }

    
    public void setList(io.crazydan.duzhou.framework.ui.XuiExpression<java.util.List> value){
        checkAllowChange();
