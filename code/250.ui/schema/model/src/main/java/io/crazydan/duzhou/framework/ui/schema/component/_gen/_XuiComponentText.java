...
public abstract class _XuiComponentText extends io.crazydan.duzhou.framework.ui.schema.component.XuiComponentNamed {
     ...
     * 
     */
    private io.crazydan.duzhou.framework.ui.XuiExpression<java.lang.String> _value ;
    ...
    public io.crazydan.duzhou.framework.ui.XuiExpression<java.lang.String> getValue(){
      return _value;
    }

    
    public void setValue(io.crazydan.duzhou.framework.ui.XuiExpression<java.lang.String> value){
        checkAllowChange();
