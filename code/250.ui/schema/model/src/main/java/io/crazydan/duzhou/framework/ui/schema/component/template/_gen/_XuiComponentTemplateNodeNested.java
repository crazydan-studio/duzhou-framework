...
public abstract class _XuiComponentTemplateNodeNested extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     *
     */
    private KeyedList<XuiNamed> _children = KeyedList.emptyList();
    ...
    public java.util.List<XuiNamed> getChildren(){
      return _children;
    }


    public void setChildren(java.util.List<XuiNamed> value){
        checkAllowChange();

        this._children = KeyedList.fromList(value, XuiNamed::getXuiName);

    }


    public XuiNamed getChild(String name){
    ...
    public void addChild(XuiNamed item) {
        checkAllowChange();
        java.util.List<XuiNamed> list = this.getChildren();
        if (list == null || list.isEmpty()) {
            list = new KeyedList<>(XuiNamed::getXuiName);
            setChildren(list);
        }
        list.add(item);
    }
