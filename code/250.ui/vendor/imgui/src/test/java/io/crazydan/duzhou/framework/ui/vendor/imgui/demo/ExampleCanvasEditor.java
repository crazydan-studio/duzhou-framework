...
public class ExampleCanvasEditor {
    ...
    public static void show(final ImBoolean showCanvaWindow) {
        ...
        if (ImGui.begin("Canvas Demo Window", showCanvaWindow)) {
            ...
            drawList.addRectFilled(canvasP0.x, canvasP0.y, canvasP1.x, canvasP1.y, ImColor.rgba(50, 50, 50, 255));
            drawList.addRect(canvasP0.x, canvasP0.y, canvasP1.x, canvasP1.y, ImColor.rgba(255, 255, 255, 255));
            ...
            for (int n = 0; n < pointList.size(); n += 2) {
                drawList.addLine(origin.x + pointList.get(n).x,
                                 origin.y + pointList.get(n).y,
                                 origin.x + pointList.get(n + 1).x,
                                 origin.y + pointList.get(n + 1).y,
