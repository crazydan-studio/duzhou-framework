...
public class ExampleImGuizmo {
    ...
    private static void editTransform(final ImBoolean showImGuizmoWindow) {
        ...
        if (ImGuizmo.isUsing()) {
            ImGuizmo.decomposeMatrixToComponents(OBJECT_MATRICES[0],
        ...
        if (ImGuizmo.isUsing()) {
            ImGuizmo.recomposeMatrixFromComponents(INPUT_MATRIX_TRANSLATION,
                                                   INPUT_MATRIX_ROTATION,
                                                   INPUT_MATRIX_SCALE,
                                                   OBJECT_MATRICES[0]);
        }
        ...
        if (USE_SNAP.get() && BOUNDING_SIZE.get() && boundSizingSnap) {
            ImGuizmo.manipulate(INPUT_CAMERA_VIEW,
                                cameraProjection,
        ...
        ImGuizmo.viewManipulate(INPUT_CAMERA_VIEW,
                                CAM_DISTANCE,
                                viewManipulateRight - 128,
                                viewManipulateTop,
                                128,
                                128,
                                0x10101010);
