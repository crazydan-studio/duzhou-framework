...
public class _DevAppService extends DynamicOrmEntity{
    ...
    public String orm_entityName() {
      ...
      return "io.crazydan.duzhou.framework.app_dev.orm.entity.DevAppService";
    }
     ...
     * 
     */
    public io.crazydan.duzhou.framework.app_dev.orm.entity.DevApp getApp(){
       return (io.crazydan.duzhou.framework.app_dev.orm.entity.DevApp)internalGetRefEntity(PROP_NAME_app);
    }

    public void setApp(io.crazydan.duzhou.framework.app_dev.orm.entity.DevApp refEntity){
    ...
    private final OrmEntitySet<io.crazydan.duzhou.framework.app_dev.orm.entity.DevAppEntity> _entities = new OrmEntitySet<>(this, PROP_NAME_entities,
        io.crazydan.duzhou.framework.app_dev.orm.entity.DevAppEntity.PROP_NAME_service, null,io.crazydan.duzhou.framework.app_dev.orm.entity.DevAppEntity.class);

    /**
     * 。 refPropName: service, keyProp: {rel.keyProp}
     */
    public IOrmEntitySet<io.crazydan.duzhou.framework.app_dev.orm.entity.DevAppEntity> getEntities(){
       return _entities;
    }
