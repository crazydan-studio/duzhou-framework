...
package io.crazydan.duzhou.framework.app_dev;
 ...
 */
@QuarkusMain
public class AppDevStarter implements QuarkusApplication {

    public static void main(String... args) {
        // https://quarkus.io/guides/lifecycle#the-main-method
        Quarkus.run(AppDevStarter.class, QuarkusStarter::stop, args);
    }
