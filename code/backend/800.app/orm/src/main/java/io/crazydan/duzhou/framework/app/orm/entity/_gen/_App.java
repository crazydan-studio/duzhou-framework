...
public class _App extends DynamicOrmEntity{
    ...
    protected App newInstance(){
       return new App();
    }

    @Override
    public App cloneInstance() {
        App entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.crazydan.duzhou.framework.app.orm.entity.App";
    }
    ...
    private final OrmEntitySet<io.crazydan.duzhou.framework.app.orm.entity.AppService> _services = new OrmEntitySet<>(this, PROP_NAME_services,
        io.crazydan.duzhou.framework.app.orm.entity.AppService.PROP_NAME_app, null,io.crazydan.duzhou.framework.app.orm.entity.AppService.class);

    /**
     * 。 refPropName: app, keyProp: {rel.keyProp}
     */
    public IOrmEntitySet<io.crazydan.duzhou.framework.app.orm.entity.AppService> getServices(){
       return _services;
    }
