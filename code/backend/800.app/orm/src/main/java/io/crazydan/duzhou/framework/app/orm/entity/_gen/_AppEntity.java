...
/**
 *  应用 ORM 实体: duzhou_app_entity
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _AppEntity extends DynamicOrmEntity{
    ...
    protected AppEntity newInstance(){
       return new AppEntity();
    }

    @Override
    public AppEntity cloneInstance() {
        AppEntity entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.crazydan.duzhou.framework.app.orm.entity.AppEntity";
    }
     ...
     * 
     */
    public io.crazydan.duzhou.framework.app.orm.entity.AppService getService(){
       return (io.crazydan.duzhou.framework.app.orm.entity.AppService)internalGetRefEntity(PROP_NAME_service);
    }

    public void setService(io.crazydan.duzhou.framework.app.orm.entity.AppService refEntity){
           ...
           internalSetRefEntity(PROP_NAME_service, refEntity,()->{
                           ...
                           this.setServiceId(refEntity.getEid());
