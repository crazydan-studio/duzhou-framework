...
/**
 *  应用服务: duzhou_app_service
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _AppService extends DynamicOrmEntity{
    ...
    protected AppService newInstance(){
       return new AppService();
    }

    @Override
    public AppService cloneInstance() {
        AppService entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "io.crazydan.duzhou.framework.app.orm.entity.AppService";
    }
     ...
     * 
     */
    public io.crazydan.duzhou.framework.app.orm.entity.App getApp(){
       return (io.crazydan.duzhou.framework.app.orm.entity.App)internalGetRefEntity(PROP_NAME_app);
    }

    public void setApp(io.crazydan.duzhou.framework.app.orm.entity.App refEntity){
           ...
           internalSetRefEntity(PROP_NAME_app, refEntity,()->{
                           ...
                           this.setAppId(refEntity.getEid());
    ...
    private final OrmEntitySet<io.crazydan.duzhou.framework.app.orm.entity.AppEntity> _entities = new OrmEntitySet<>(this, PROP_NAME_entities,
        io.crazydan.duzhou.framework.app.orm.entity.AppEntity.PROP_NAME_service, null,io.crazydan.duzhou.framework.app.orm.entity.AppEntity.class);

    /**
     * 。 refPropName: service, keyProp: {rel.keyProp}
     */
    public IOrmEntitySet<io.crazydan.duzhou.framework.app.orm.entity.AppEntity> getEntities(){
       return _entities;
    }
