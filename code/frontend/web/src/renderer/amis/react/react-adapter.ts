...
import { PageOptions, createPage } from '@/sdk/nop-core';
import type { PageObject, RegisterPage } from '@/sdk/nop-core';
...
export function defineReactPageComponent(
  builder: (props: { actions?: Record<string, Function> }) => ReactPageOptions
) {
  return defineComponent({
    ...
    setup(props) {
      ...
      function renderPage() {
        ...
        const r = root;
        const vdom = Promise.resolve(
          options.onRenderPage(schema, props.data, page)
        );
